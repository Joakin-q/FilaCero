/**
 * config.js — Configuración de FilaCero
 */
...
window.FC_CONFIG = {
  ...
  fallbackToLocal: true,     // Si Firebase falla o no está configurado, usa localStorage
  lockUI: false              // true = bloquea botones (modo demo visual); false = funcionalidad activa
};
